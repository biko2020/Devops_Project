...
sudo -u postgres bash -c "psql -c \"CREATE DATABASE Ensetdbdev OWNER vagrant;\""
sudo -u postgres bash -c "psql -c \"CREATE DATABASE Ensetdbstage OWNER vagrant;\""
sudo -u postgres bash -c "psql -c \"CREATE DATABASE Ensetdbprod OWNER vagrant;\""
